...
\copy products(produrl, perfume, gender, rating_value, rating_count, create_year, top_note, middle_note, base_note, price, country_id, brand_id) FROM '/docker-entrypoint-initdb.d/products.csv' WITH (FORMAT csv, HEADER true, DELIMITER ';')
